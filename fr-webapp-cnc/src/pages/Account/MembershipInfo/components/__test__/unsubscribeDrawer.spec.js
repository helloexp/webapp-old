...
import UnsubscribeDrawerTest from '../UnsubscribeDrawer';

function mountItem() {
  return testHelpers.mountWithAll(<UnsubscribeDrawerTest />);
}

describe('UnsubscribeDrawer component', () => {
  it('should render UnsubscribeDrawer', () => {
