Feature: ACC40
  ...
  Scenario: New user with Pick up at Uniqlo store, Hemming and Payment with One Gift Card and Credit Card(ACC40)
    ...
    Given User adds products for "ACC40" to cart from mock page
    Given User goes to Cart
