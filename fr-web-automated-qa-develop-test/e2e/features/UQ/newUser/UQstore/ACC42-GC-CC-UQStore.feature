Feature: ACC42
  ...
  Scenario: New user with Pick up at Uniqlo store and Payment with Three Gift Cards and Credit Card(ACC42)
    ...
    Given User adds products for "ACC42" to cart from mock page
    Given User goes to Cart
