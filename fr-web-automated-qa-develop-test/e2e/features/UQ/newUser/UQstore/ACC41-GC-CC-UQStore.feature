Feature: ACC41
  ...
  Scenario: New user with Pick up at Uniqlo store and Payment with Two Gift Cards and Credit Card(ACC41)
    ...
    Given User adds products for "ACC41" to cart from mock page
    Given User goes to Cart
