Feature: ACC33
  ...
  Scenario: New user with new Shipping Address and Two Gift Card, Credit Card with Yupacket (ACC33)
    ...
    Given User adds products for "ACC33" to cart from mock page
    Given User goes to Cart
