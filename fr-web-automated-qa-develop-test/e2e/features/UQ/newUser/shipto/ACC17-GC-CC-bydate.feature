Feature: ACC17
  ...
  Scenario: New user with Shipping Address with By Date delivery and Payment using Three Gift Card and Credit Card(ACC17)
    ...
    Given User adds products for "ACC17" to cart from mock page
    Given User goes to Cart
