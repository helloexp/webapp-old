Feature: ACC04
  ...
  Scenario: New user with new Shipping Address with Three Giftcard, hemming and standard delivery(ACC 04)
    ...
    Given User adds products for "ACC4" to cart from mock page
    Given User goes to Cart
