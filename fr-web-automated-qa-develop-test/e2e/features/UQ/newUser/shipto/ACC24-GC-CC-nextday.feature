Feature: ACC24
  ...
  Scenario: New user with new Shipping Address and One Gift Card and Credit Card with Nextday (ACC24)
    ...
    Given User adds products for "ACC24" to cart from mock page
    Given User goes to Cart
