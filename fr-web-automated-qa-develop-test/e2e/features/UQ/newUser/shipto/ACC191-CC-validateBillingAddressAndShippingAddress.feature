Feature: ACC191
  ...
  Scenario: New user with Shipping Address and Credit Card validates Shipping Address and Billing Address(ACC191)
    ...
    Given User adds products for "ACC191" to cart from mock page
    Given User goes to Cart
    ...
    Then User verifies whether shipping address and billing address are same 
