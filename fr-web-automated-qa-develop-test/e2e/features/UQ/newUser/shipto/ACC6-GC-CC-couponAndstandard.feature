Feature: ACC06
  ...
  Scenario: New user with new Shipping Address, gifting and One Giftcard and creditCard with coupon and standard Delivery(ACC 06)
    ...
    Given User adds products for "ACC6" to cart from mock page
    Given User goes to Cart
