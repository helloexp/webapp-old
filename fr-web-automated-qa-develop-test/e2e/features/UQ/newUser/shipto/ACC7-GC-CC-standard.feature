Feature: ACC07
  ...
  Scenario: New user with new Shipping Address, Two Giftcard and creditCard and standard Delivery(ACC 07)
    ...
    Given User adds products for "ACC7" to cart from mock page
    Given User goes to Cart
