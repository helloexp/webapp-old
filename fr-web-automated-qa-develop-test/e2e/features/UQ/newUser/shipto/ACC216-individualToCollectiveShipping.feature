Feature: ACC216
  ...
  Scenario: New user with Split Delivery with individual shipping using Credit Card changes to collective shipping (ACC216)
    ...
    Given User adds products for "ACC216" to cart from mock page
    Given User goes to Cart
