Feature: ACC217
  ...
  Scenario: New user with Split Delivery with Collective Shipping using Credit Card changes to Individual Shipping (ACC217)
    ...
    Given User adds products for "ACC217" to cart from mock page
    Given User goes to Cart
