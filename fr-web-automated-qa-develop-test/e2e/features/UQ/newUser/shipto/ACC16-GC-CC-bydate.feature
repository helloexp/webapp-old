Feature: ACC16
  ...
  Scenario: New user with Shipping Address with By Date delivery and Payment using Two Gift Card and Credit Card(ACC16)
    ...
    Given User adds products for "ACC16" to cart from mock page
    Given User goes to Cart
