Feature: ACC212
  ...
  Scenario: New user with Split Delivery with nextday shipping and standard shipping using Credit Card (ACC212)
    ...
    Given User adds products for "ACC212" to cart from mock page
    Given User goes to Cart
    ...
    When User selects bydate shipping method for Delivery 3
