Feature: ACC32
  ...
  Scenario: New user with new Shipping Address and Gift Card And Credit Card with Yupacket (ACC32)
    ...
    Given User adds products for "ACC32" to cart from mock page
    Given User goes to Cart
