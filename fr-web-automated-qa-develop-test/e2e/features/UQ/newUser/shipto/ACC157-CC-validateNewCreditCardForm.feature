Feature: ACC157 (Jira ACC386)

  Scenario: New user with New Credit Card validate form mandatory fields (ACC157)
    ...
    Given User adds products for "ACC157" to cart from mock page
    Given User goes to Cart
    ...
    When User validates the credit card details
