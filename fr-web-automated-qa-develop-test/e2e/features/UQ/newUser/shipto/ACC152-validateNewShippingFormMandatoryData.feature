Feature: ACC152 (Jira ACC380)

  Scenario: New user with new shipping address validate shipping address form for mandatory fields (ACC152)
    ...
    Given User adds products for "ACC152" to cart from mock page
    Given User goes to Cart
