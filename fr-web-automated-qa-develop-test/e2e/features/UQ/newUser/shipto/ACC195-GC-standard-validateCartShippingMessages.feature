Feature: ACC195
  ...
  Scenario: New user with new Shipping Address, One Giftcard and standard Validates the Cart Shipping Messages(ACC195)
    ...
    Given User adds products for "ACC195" to cart from mock page
    Given User goes to Cart
    Then Products are present in Cart page
    When User gets the order summary price details
    When User validates the uq cart for shipping messages
