Feature: ACC218
  ...
  Scenario: New user with Split Delivery with next day shipping and bydate shipping using Credit Card (ACC218)
    ...
    Given User adds products for "ACC218" to cart from mock page
    Given User goes to Cart
    ...
    When User selects nextday shipping method for Delivery 3
