Feature: ACC126
  ...
  Scenario: Existing user with CVS Family Mart store and Gift card, Credit Card (ACC126)
    Given User goes to Cart
    When User goes to Login page
    When User logs in
      | email    | automation126@uniqlo.com |
      | password | test1234                 |

    Then User is successfully logged in
    Given User adds products for "ACC126" to cart from mock page
