Feature: ACC128
  ...
  Scenario: Existing user with CVS Family Mart store and Three Gift Card, Credit Card (ACC128)
    Given User goes to Cart
    When User goes to Login page
    When User logs in
      | email    | automation128@uniqlo.com |
      | password | test1234                 |

    Then User is successfully logged in
    When Prerequisites Reset user Cart data
    Given User adds products for "ACC128" to cart from mock page
