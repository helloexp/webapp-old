Feature: ACC132
  ...
  Scenario: Existing user with CVS Lawson and Three Gift Card (ACC 132)
    Given User goes to Cart
    When User goes to Login page
    When User logs in
      | email    | automation132@uniqlo.com |
      | password | test1234                 |

    Then User is successfully logged in
    Given User adds products for "ACC132" to cart from mock page
