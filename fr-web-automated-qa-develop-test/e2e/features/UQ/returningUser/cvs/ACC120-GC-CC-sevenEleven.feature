Feature: ACC120
  ...
  Scenario: Existing user with CVS Seven store and three Gift Card, Credit Card (ACC120)
    Given User goes to Cart
    When User goes to Login page
    When User logs in
      | email    | automation120@uniqlo.com |
      | password | test1234                 |

    Then User is successfully logged in
    Given User adds products for "ACC120" to cart from mock page
