Feature: ACC121
  ...
  Scenario: Existing user with CVS Seven store and Pay At Store (ACC121)
    Given User goes to Cart
    When User goes to Login page
    When User logs in
      | email    | automation121@uniqlo.com |
      | password | test1234                 |

    Then User is successfully logged in
    Given User adds products for "ACC121" to cart from mock page
