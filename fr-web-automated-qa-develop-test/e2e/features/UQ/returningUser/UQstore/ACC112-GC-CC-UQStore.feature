Feature: ACC112
  ...
  Scenario: Existing user with Pick up at Uniqlo store and Payment with Three Gift Cards and Credit Card(ACC112)

    Given User goes to Cart
    When User goes to Login page
    When User logs in
      | email    | automation112@uniqlo.com |
      | password | test1234                 |

    Then User is successfully logged in
    When Prerequisites Reset user Cart data
    Given User adds products for "ACC112" to cart from mock page
    Given User goes to Cart
