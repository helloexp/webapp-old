Feature: ACC80
  ...
  Scenario: Existing user with Shipping Address, bydate, gifting as uniqlo box and Payment using one Gift Card (ACC80)
    Given User goes to Cart
    When User goes to Login page
    When User logs in
      | email    | automation80@uniqlo.com|
      | password | test1234                 |

    Then User is successfully logged in
    Given User adds products for "ACC80" to cart from mock page
