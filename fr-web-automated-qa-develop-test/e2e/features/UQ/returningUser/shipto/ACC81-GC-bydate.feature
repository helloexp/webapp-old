Feature: ACC81
  ...
  Scenario: Existing user with Shipping Address, bydate and Payment using two Gift Cards (ACC81)
    Given User goes to Cart
    When User goes to Login page
    When User logs in
      | email    |  automation81@uniqlo.com |
      | password | test1234                 |

    Then User is successfully logged in
    Given User adds products for "ACC81" to cart from mock page
