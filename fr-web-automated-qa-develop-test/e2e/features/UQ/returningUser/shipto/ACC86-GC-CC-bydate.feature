Feature: ACC86
  ...
  Scenario: Existing user with Shipping Address, Bydate and Payment using three Gift Cards and Credit Card (ACC86)
    Given User goes to Cart
    When User goes to Login page
    When User logs in
      | email    | automation86@uniqlo.com |
      | password | test1234                 |

    Then User is successfully logged in
    When Prerequisites Reset user Cart data
    Given User adds products for "ACC86" to cart from mock page
