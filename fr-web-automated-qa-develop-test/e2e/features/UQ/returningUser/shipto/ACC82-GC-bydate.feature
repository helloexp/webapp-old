Feature: ACC82
  ...
  Scenario: Existing user with Shipping Address, bydate and Payment using three Gift Cards (ACC82)
    Given User goes to Cart
    When User goes to Login page
    When User logs in
      | email    | automation82@uniqlo.com |
      | password | test1234                |

    Then User is successfully logged in
    When Prerequisites Reset user Cart data
    Given User adds products for "ACC82" to cart from mock page
