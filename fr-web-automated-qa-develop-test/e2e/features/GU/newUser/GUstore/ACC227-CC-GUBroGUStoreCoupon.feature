Feature: ACC227
  ...
  Scenario: New user with GUPick up at Uniqlo store, Gifting as Uniqlo, Coupon and Payment with creditCard (ACC227)
    ...
    Given User adds products for "ACC227" to cart from mock page
